defmodule Sample.Manifest.RpcGen.Schema do
  require Logger

  @manifest Macro.escape(Sample.Manifest.RpcGen.Builder.build_validated!(:sample))
  ...
  def dispatch(remote \\ Node.self(), wire_name, payload) do
    if remote == Node.self(),
